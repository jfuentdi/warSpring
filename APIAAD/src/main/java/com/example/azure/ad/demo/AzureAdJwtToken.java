...
public class AzureAdJwtToken {
    ...
    protected final Integer issuedAt;
    protected final Integer expireAt;
    ...
    public AzureAdJwtToken(String token) {
        ...
        issuedAt = payload.getInt("iat");
        expireAt = payload.getInt("exp");
        if (log.isDebugEnabled()) {
    ...
    public String toString() {
        return "AzureAdJwtToken [issuer=" + issuer + ", ipAddr=" + ipAddr + ", name=" + name + ", uniqueName=" + uniqueName +", issuedAt="+ issuedAt +", expireAt="+ expireAt +"]";
    } 
}